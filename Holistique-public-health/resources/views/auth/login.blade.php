...
<head>
    ...
    <title>Holistique dashboard</title>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <!-- <img src="images/admin.jpg" alt="Volunteers" class="img-fluid " style="background-position:cover" width="100%" height="200%" cover >
                         -->
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login into admin panel</h1>
                                    </div>
