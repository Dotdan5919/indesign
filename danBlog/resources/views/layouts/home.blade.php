...
<html data-wf-page="6577019a915bb98abc733643">
    <head>
        ...
        <link href="{{asset('assets/css/style_2.css')}}" rel="stylesheet" type="text/css" />
        ...
        <div class="header">
            <div class="w-layout-blockcontainer main-container w-container">
                <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="header-inner w-nav">
                    <a href="index.html" aria-current="page" class="logo w-inline-block w--current"><img src="{{asset('assets/images/logo.png')}}" alt="" class="logo-img" /></a>
                    ...
                    <div class="header-right-side">
                        <form action="#" class="search-div w-form">
                            ...
                            <img src="{{asset('images/search.png')}}" alt="" class="image" />
                        </form>
                    </div>
                </div>
            </div>
