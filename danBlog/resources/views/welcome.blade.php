...
@section('content')
                    ...
                    <div role="list" class="home-category-list w-dyn-items">
                        <div role="listitem" class="w-dyn-item">
                            <a
                                ...
                                style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; height:140px "
                                href="category.html"
                                class="category-grid-item w-inline-block"
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/entertainment.jpeg')}}"
                                ...
                                <img
                                    src="{{asset('assets/images/readmore.png')}}"
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/nature.jpg')}}"
                                    class="blog-category-main-image"
                                    style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                />
                                <div class="gradient-overlay"></div>
                        ...
                        <div role="listitem" class="w-dyn-item">
                            <a
                                data-w-id="4cd9ff82-9f16-1c9a-a92d-da3323fc9873"
                                style="height:140px; opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                href="category.html"
                                class="category-grid-item w-inline-block"
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/gaming.jpeg')}}"
                                    class="blog-category-main-image"
                                    style=""
                                />
                                <div class="gradient-overlay"></div>
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/business.png')}}"
                                    class="blog-category-main-image"
                                    style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                />
                                <div class="gradient-overlay"></div>
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/science.jpeg')}}"
                        ...
                        <div role="listitem" class="w-dyn-item">
                            <a
                                data-w-id="4cd9ff82-9f16-1c9a-a92d-da3323fc9873"
                                style="height:140px; opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;height:140px"
                                href="category.html"
                                class="category-grid-item w-inline-block"
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    loading="lazy"
                                    src="{{asset('assets/images/sport.jpeg')}}"
                                    class="blog-category-main-image"
                                    style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                />
                                <div class="gradient-overlay"></div>
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    loading="lazy"
                                    src="{{asset('assets/images/travel.jpg')}}"
                                    class="blog-category-main-image"
                                    style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                />
                                <div class="gradient-overlay"></div>
                  ...
                  <div role="list" class="latest-blog-4-col-grid w-dyn-items">
                      <div role="listitem" class="w-dyn-item">
                          ...
                          >
                              <img
                                  alt=""
                                  src="{{asset('assets/images/post16.jpg')}}"
                      ...
                      <div role="listitem" class="w-dyn-item">
                          ...
                          >
                              <img
                                  alt=""
                                  src="{{asset('assets/images/post21.jpg')}}"
                                  class="latest-blog-4-col-image"
                              />
                      ...
                      <div role="listitem" class="w-dyn-item">
                          ...
                          >
                              <img
                                  alt=""
                                  src="{{asset('assets/images/post24.jpg')}}"
                                  class="latest-blog-4-col-image"
                              />
                      ...
                      <div role="listitem" class="w-dyn-item">
                          ...
                          >
                              <img
                                  alt=""
                                  src="{{asset('assets/images/post25.jpg')}}"
                                  class="latest-blog-4-col-image"
                              />
                        ...
                        >
                            <a data-w-id="8251edd9-9261-4de3-6c77-dd69fe9ce26a" href="singleblog.html" class="blog-list-item w-inline-block">
                                ...
                                <div class="blog-meta">
                                    ...
                                    <img src="{{asset('assets/images/arrow.png')}}" style="opacity: 0;" alt="" class="blog-meta-arrow" />
                                </div>
        ...
        <section class="moving-text-section">
            <div
                data-w-id="a0231212-b5c8-f0cb-b3f7-89d0e89e298f"
                style="
                    ...
                    <div role="list" class="tech-category-list w-dyn-items">
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/post10.jpg')}}"
                                    class="tech-category-image"
                                    style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"
                                />
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/post2.jpg')}}"
                                    class="tech-category-image"
                                />
                                <div class="tech-text-box">
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/post23.jpg')}}"
                                    class="tech-category-image"
                                />
                                <div class="tech-text-box">
                        ...
                        <div role="listitem" class="w-dyn-item">
                            ...
                            >
                                <img
                                    alt=""
                                    src="{{asset('assets/images/post12.jpg')}}"
                                    class="tech-category-image"
                                />
                                <div class="tech-text-box">
                            ...
                            <div role="list" class="single-education-list w-dyn-items">
                                <div role="listitem" class="w-dyn-item">
                                    <a href="singleblog.html" class="single-education-item w-inline-block">
                                        <img
                                            alt=""
                                            src="{{asset('assets/images/post11.jpg')}}"
