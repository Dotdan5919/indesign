...
<div class="  p-8 shadow-sm rounded-sm bg-white dark:bg-darkblack-600">
    ...
    <form action=<?php echo e(route('upload_blog')); ?> method="POST" enctype="multipart/form-data" class="space-y-6">
...
init();
  ...
  <div id="blog-card-container" class="flex flex-col gap-5" >
      ...
      <a href="#" class="flex gap-2 justify-between  items-center  ">
        <div  style="width: 60%"> 
        <h4 class="heading2  " ><?php echo e($blog->title); ?></h4>
      ...
      <div class="rounded-full w-24 h-24  overflow-hidden flex justify-center items-center m-5  " style=""> 
        <img src="storage/uploads/<?php echo e($blog->image); ?> " alt="" class="">
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ighodaro Daniel\danBlog\resources\views/admin.blade.php ENDPATH**/ ?>