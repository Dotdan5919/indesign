        ...
        <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
          ...
          <div class="max-w-[450px] m-auto pt-24 pb-16">
            <header class="text-center mb-8">
              ...
              >
                Sign in to danBlog Admin dashboard.
              </h2>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
              ...
              <div class="mb-6 relative">
                ...
                />
                <button class="absolute top-4 right-4 bottom-4" id="passwordToggle" onclick="Toggle()">
                  <svg
                    width="22"
                    height="20"
                    viewBox="0 0 22 20"
            ...
            <div>
              ...
              <form action="">
                <div class="mb-6 relative">
                  <input
                    type="text"
                    class="text-bgray-800 text-base border border-bgray-300 h-14 w-full 
...
function Toggle()
{
  ...
  var eye= document.getElementById('passwordToggle');
...
<?php /**PATH C:\Users\Ighodaro Daniel\danBlog\resources\views/signin.blade.php ENDPATH**/ ?>