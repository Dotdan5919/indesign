...
interface PropType{img:StaticImageData,name:string,projects:number}

export default function ImgSliderContainer2({img,name,projects}:PropType) {
  return (
...
<p className='w-full'>{projects} Projects</p>
